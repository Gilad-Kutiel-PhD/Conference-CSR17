...
\draw 
plot[upper] (10,1.2) -- +(-5pt,0) -- +(5pt,0) 
node[right]{\tiny Upper Bound};

\draw[yshift=-\baselineskip] 
plot[unweight] (10,1.2) -- +(-5pt,0) -- +(5pt,0) 
node[right]{\tiny Unweighted};

\draw[yshift=-2\baselineskip] 
plot[weight-vertex] (10,1.2) -- +(-5pt,0) -- +(5pt,0) 
node[right]{\tiny Vertex Weighted};

\draw[yshift=-3\baselineskip] 
plot[weight-edge] (10,1.2) -- +(-5pt,0) -- +(5pt,0) 
